//pagina inicial
function entrar() {
  document.location.href = 'quizMath.html';
}
...
function conferir1() {
  ...
  if (resposta == 'b' || resposta == 'B' || resposta == '42') {
...
function conferir2() {
  ...
  if (resposta == 'a' || resposta == 'A' || resposta == '54') {
...
function conferir3() {
  ...
  if (resposta == 'c' || resposta == 'C' || resposta == '1/2') {
...
function conferir4() {
  ...
  if (resposta == 'c' || resposta == 'C' || resposta == '49') {
...
function conferir5() {
  ...
  if (resposta == 'b' || resposta == 'B' || resposta == '60') {
...
function conferir7() {
  ...
  if (resposta == 'd' || resposta == 'D' || resposta == '25') {
...
function conferir8() {
  ...
  if (resposta == 'c' || resposta == 'C' || resposta == '7') {
...
function conferir9() {
  ...
  if (resposta == 'b' || resposta == 'B' || resposta == '10') {
